...
def Key_Stats(gather=None):
    ...
    df = pd.DataFrame(columns=['Date',
                               ...
                               ##############
                               'Status'])
    sp500_df = pd.read_csv('data/YAHOO-INDEX_GSPC.csv', index_col='Date', parse_dates=True)
    ticker_list = []
    for each_dir in sorted(stock_list)[1:]:
        ...
        #         else:
        #             color = 'g'
        #         plot_df['Difference'].plot(label=each_ticker, color=color, figsize=(12, 10))
        #     except:
        #         pass
